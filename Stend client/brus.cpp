...
if(parse.Pos("pt_012=")){
        ...
        pt_012->Text = parse.Insert(" Бар", parse.Length()+1);
}
//
if(parse.Pos("tt_008=")){
        parse.Delete(1,parse.Pos("="));
...
if(parse.Pos("pit_003=")){
        parse.Delete(1,parse.Pos("="));
        pit_003->Text = parse.Insert(" Бар", parse.Length()+1);
}
//
if(parse.Pos("tt_202=")){
        parse.Delete(1,parse.Pos("="));
...
if(parse.Pos("ft_002=")){
        parse.Delete(1,parse.Pos("="));
        ft_002->Text = parse.Insert(" м3/ч", parse.Length()+1);
}
//
if(parse.Pos("psl_064=")){
        parse.Delete(1,parse.Pos("="));
        psl_064->Text = parse.Insert(" Бар", parse.Length()+1);
}
//
...
if(parse.Pos("pit_001=")){
        parse.Delete(1,parse.Pos("="));
        pit_001->Text = parse.Insert(" Бар", parse.Length()+1);
}
//
if(parse.Pos("pdit_001=")){
        parse.Delete(1,parse.Pos("="));
        pdit_001->Text = parse.Insert(" Бар", parse.Length()+1);
}
//
if(parse.Pos("fit_001=")){
        parse.Delete(1,parse.Pos("="));
        fit_001->Text = parse.Insert(" м3/ч", parse.Length()+1);
}
//
if(parse.Pos("tt_004=")){
        parse.Delete(1,parse.Pos("="));
        tt_004->Text = parse.Insert(" С", parse.Length()+1);
}
//
...
if(parse.Pos("pt_049=")){
        parse.Delete(1,parse.Pos("="));
        pt_049->Text = parse.Insert(" Бар", parse.Length()+1);
}
//
if(parse.Pos("tt_001=")){
        parse.Delete(1,parse.Pos("="));
        tt_001->Text = parse.Insert(" С", parse.Length()+1);
}

//
if(parse.Pos("tt_001_yst=")){
        parse.Delete(1,parse.Pos("="));
        tt_001_yst->Text = parse.Insert(" С", parse.Length()+1);
}
//
if(parse.Pos("tt_004_yst=")){
        parse.Delete(1,parse.Pos("="));
        tt_004_yst->Text = parse.Insert(" С", parse.Length()+1);
}
//
...
if(parse.Pos("fit_001_yst=")){
        parse.Delete(1,parse.Pos("="));
        fit_001_yst->Text = parse.Insert(" м3/ч", parse.Length()+1);
}
//
...
if(sw_ypg_pds_vibor->Tag == 0) {
        distance_podogrev->Text = "НЕТ";
}
if(sw_ypg_pds_vibor->Tag == 1) {
        distance_podogrev->Text = "ДА";
}
if(sw_well_pds_vibor->Tag == 0) {
        distance_rashod->Text = "НЕТ";
}
if(sw_well_pds_vibor->Tag == 1) {
        distance_rashod->Text = "ДА";
}
//------------------
//
