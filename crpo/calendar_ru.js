...
document.write('<table id="fc" style="z-index:2;position:absolute;border-collapse:collapse;background:#FFFFFF;border:1px solid #BBBBBB;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none;" cellpadding="2">');
...
document.write('<tr style="background:#BBBBBB;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#BBBBBB" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
function f_cps(obj) {
	...
	obj.style.border='1px solid #BBBBBB';//'1px solid #606060';
	...
	for(var d=1;d<=42;d++) {
		...
		if ((d >= (cd -(-1)))&&(d<=cd-(-marr[cm]))) {
			...
			if (sccm == cm && sccd == (d-cd) && sccy == cy)
				cv.style.color='#FF2020';

			// if selected date
			if (cm == selectedm && cy == selectedy && selectedd == (d-cd) )
			{
				cv.style.background='#BBBBBB';
