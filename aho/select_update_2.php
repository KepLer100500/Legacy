...
echo "</td></tr><tr><td>Период действия||Начало</td><td><input type='text' name='date_begin_edit' size='70' value='$date_begin'></td></tr><tr><td>Период действия||Конец</td><td><input type='text' name='date_end_edit' size='70' value='$date_end'></td></tr><tr><td>Подразделение</td><td><input type='text' name='department_edit' size='70' value='$department'></td></tr><tr><td>Код МВЗ</td><td><input type='text' name='code_mvz_edit' size='70' value='$code_mvz'></td></tr><tr><td>МВЗ</td><td><input type='text' name='mvz_edit' size='70' value='$mvz'></td></tr></table><br><center><input type='button' value='Редактировать' onclick='do_update();'></center>";
?>
